...
if !exists("html_no_rendering")
	...
	sy region htmlUnderlineBoldIta  sy region htmlUnderlineBoldIta  sy region htmlUnderlineBoins=@htmlTop
	sy region htmlUnderlineBoldItalic contained start="<em\>"     end="</em>"me=e-5     contains=@htmlTop

	sy re  sy re  sy re  sy re  sy re  sy re  sy re  sy re  sy re  sy/i>"me=e-4      contains=@htmlTop,htmlItalicBold,htmlItalicUnderline
	...
	sy region html  sy region html  sy region html  sy region html  sy region h>"  sy region html  sy region html  sy region html  sy region hhtmlItalicBoldUnderline contained start="<u\>"      end="</u>"me=e-4      contains=@htmlTop
	sy region htmlItalicUnderline       sy region htmlItalicUnderline       sy region htmlItalicUndtmlTop,htmlItalicUnderlineBold
	sy region htmlItalicUnderlineBold contained start="<b\>"      end="</b>"me=e-4      contains=@htmlTop
	sy region htmlItalicUnderlineBold contained start="<st  sy region htmlItalicUnderlineBold contained start="<st  sy  htmlH1    start="<h1\>"    end="</h1>"me=e-5    contains=@htmlTop
	sy region htmlH2    start="<h2\>"    end="</h2>"me=e-5    c  sy region htmlH2    start="<h2\>"    end="</h2>"me=e-5    c</h3>"me=e-5    contains=@htmlTop
	sy region htmlH4    start="<h4\>"    end="</h4>"me=e-5    contains=@htmlTop
	sy region html  sy region html  sy region html  sy region html  sy region h
	sy region htmlH6    start="<h6\>"    end="</h6>"me=e-5    contains=@htmlTop
endif


" No htmlTop and wikiPre inside HTML pr" No htmlTop and wikiPre inside HTML pr" No htmlTop and wikiPhere literally (HTML tags and
" entities, too): <pre> tags work a" entities, too): <pre> tags work a" entities, too: <pre> taag: the content will preformatted, and it
...
sy matsy matsy matsy matsy matsy matsy matsy matsy matsy matsy matstcsy matsy matsy matsy matsy matsy matsy matsy matsy matsy matswikiNowikiEndTag /<\/nowiki>/    contains=htmlEndTag
...
sy region htmlPre    start="<pre>"     sy region htmlPre    start="<pre>"     sy region htmlPre    sion wikiNowiki start="<nowiki>"              end="<\/nowiki>"me=e-9 contains=wikiNowikiTag
sy region wikiSource start="<source\ssy region wikiSource start="<source\ssy region wikiSource stakiSourceTag
...
if version >= 508 || !exists("did_html_syn_inits")
	...
	if !exists("html_no_rendering")
		...
		HtmlHiLi    HtmlHiLi    HtmlHiLi    HtmlHiLi    HtmlHiLi    HtmlHiLi HiLink htmlItalicBold          htmlBoldItalic
		HtmlHiLink html    HtmlHiLink html    HtmlHiLink html    HtmlHiLink html    derlineBold       htmlBoldUnderline
